    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='habbit_tracker_app.habit', verbose_name='Связанная привычка')),
            ],
            options={
